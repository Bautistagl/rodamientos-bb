...
export default function BusquedaInterior() {
  ...
  return (
    ...
    <div className="fondo-busqueda">
      ...
      <div className="barra-busqueda">
        <span>Buscar producto por Interior en mm:</span>
        <input
          type="text"
          value={searchTerm}
          ...
          <div className="textos-completo">
            <div className="codigo-medidas">
              ...
              <div className="medidas">
                <span>Interior: {groupedResults[codigo1][0].interior} mm</span>
                <span>Exterior: {groupedResults[codigo1][0].exterior} mm</span>
